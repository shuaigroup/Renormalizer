...
class Test_exactsolver_timeautocorr(unittest.TestCase):
    ...
    def test_exact(self):
        ...
        # abs
        autocorr, E2 = exact_solver.ZT_time_autocorr(dipolemat, ic, fc, ie, fe, "+", nsteps, dt)
        ...
        autocorr, E1, E2 = exact_solver.FT_time_autocorr(T, dipolemat, ic, fc, ie, fe, "+", nsteps, dt)
        ...
        #emi
        autocorr, E2 = exact_solver.ZT_time_autocorr(dipolemat, fc, ic, fe, ie, "-", nsteps, dt)
        ...
        autocorr, E1, E2 = exact_solver.FT_time_autocorr(T, dipolemat, fc, ic, fe, ie, "-", nsteps, dt)
