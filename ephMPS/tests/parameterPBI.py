...
omega_quantities = [Quantity(206.0, "cm^{-1}"), Quantity(211.0, "cm^{-1}"),
                    Quantity(540.0, "cm^{-1}"), Quantity(552.0, "cm^{-1}"),
                    Quantity(751.0, "cm^{-1}"), Quantity(1325.0, "cm^{-1}"),
                    Quantity(1371.0, "cm^{-1}"), Quantity(1469.0, "cm^{-1}"),
                    Quantity(1570.0, "cm^{-1}")]
omega = [
