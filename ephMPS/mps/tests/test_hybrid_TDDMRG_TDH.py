...
class Test_hybrid_TDDMRG_TDH(unittest.TestCase):
    ...
    def test_hybrid_DMRG_H_SCF(self, mol_list, target):
        ...
        nexciton = 1
        mps, mpo = solver.construct_mps_mpo_2(mol_list, dmrg_procedure[0][0], nexciton, scheme=2)
        niterations = 20
        Etot = solver.optimize_mps(mps, mpo, dmrg_procedure, niterations=niterations, dmrg_thresh=1e-5, hartree_thresh=1e-5)
        print("Etot", Etot)
        ...
        mps, mpo = solver.construct_mps_mpo_2(mol_list, dmrg_procedure[0][0], nexciton, scheme=2)
        niterations = 20
        Etot = solver.optimize_mps(mps, mpo, dmrg_procedure, niterations=niterations, dmrg_thresh=1e-5,
                                   hartree_thresh=1e-5)
        print("Etot", Etot)
