...
from renormalizer.mps import Mpo, gs
...
def test_quasiboson_constructMPO():
    ...
    energy = gs.optimize_mps(mps2, mpo2)
...
def test_quasiboson_solver(value):
    ...
    mps3, mpo3 = gs.construct_mps_mpo_2(
    ...
    for method in ["1site", "2site"]:
        ...
        energy1 = gs.optimize_mps(mps1, mpo1)
        energy2 = gs.optimize_mps(mps2, mpo2)
        energy3 = gs.optimize_mps(mps3, mpo3)
